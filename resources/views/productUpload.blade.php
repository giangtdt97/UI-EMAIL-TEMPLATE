...
@section('content')
    ...
    <p>Your product (Product Name) has been successfully uploaded!</p>
    <p>To make changes to the product, click this link <a href="#">(Hyperlink to Product Name page)</a></p>
    <p>To make changes to your seller account page, click this link <a href="#">(Hyperlink to Seller Account page)</a></p>
