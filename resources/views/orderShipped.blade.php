...
@section('content')
    ...
    <p>Your product Invoice #(Invoice Number) is being shipped to the customer.</p>
    <p>Once the product has been received by the customer, we will send you a notification email and the payment will be released into your account in 2 weeks’ time.</p>
